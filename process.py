...
from inference import segment_isles22_pipeline
...
class vicorob_uresnet():
    ...
    def predict(self, input_data):
        ...
        prediction = segment_isles22_pipeline(
            dwi_sitk_img=dwi_image,
            adc_sitk_img=adc_image,
            flair_sitk_img=flair_image,
            models_filepaths=[f'/opt/algorithm/models/best_fold_{i}.ckpt' for i in range(5)],
            threshold=0.35
        )
